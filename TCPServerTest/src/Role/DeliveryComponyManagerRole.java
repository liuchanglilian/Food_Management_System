...
import userInterface.DeliveryManager.DeliveryManegerWorkArea;
 ...
 * @author liuch
 */
public class DeliveryComponyManagerRole extends Role implements Serializable{
  ...
  /*  public static long getSerialVersionUID() {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account,Network network, Enterprise enterprise, Organization organization, EcoSystem system, ObjectOutputStream streamOut) {
     return new DeliveryManegerWorkArea(system,userProcessContainer,account, network,enterprise,streamOut) ;
    } 
