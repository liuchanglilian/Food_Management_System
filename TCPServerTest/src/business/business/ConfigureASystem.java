...
// Orphane o=  (Orphane)network.getEnterpriseDirectory().createAndAddEnterprise("Pho&Basil", Enterprise.EnterpriseType.Orphane,"Chang","BackBay_Ophane", "123");
    //  BioFactory bio=(BioFactory)network.getEnterpriseDirectory().createAndAddEnterprise("Pho&Basil", Enterprise.EnterpriseType.Biofactory,"Chang","BackBay_Biofactory", "123");
...
//      r.addMenu("Pho", 20);
  //    r.addMenu("Thai MilkTea", 10);
    //  r.addMenu("Spicy Eggplant", 5);
...
//  r2.addMenu("Pop chicken", 7);
    //  r2.addMenu("Cola", 2);
     // r2.addMenu("Tender chicken", 5);
      network.getEnterpriseDirectory().createAndAddEnterprise("BackBay Ophan", Enterprise.EnterpriseType.Orphane,"Chang","Wen", "123");
      //  network.getEnterpriseDirectory().createAndAddEnterprise("Pho&Basil", Enterprise.EnterpriseType.Restaurant,"Chang","Pho&Basil", "123");
