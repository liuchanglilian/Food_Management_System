    ...
    public void populateTable() {
        ...
        for (WorkRequest f : account.getWorkQueue().getWorkRequestList()) {
         ...
         { FoodOrderRequest food = (FoodOrderRequest) f;
            ...
            //This should check whether the food is ready for longer than 2h, for test, I set it to be 30 second
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (row < 0) {
            ...
            if (p.getOrder().getDiscountFoodList().size() == 0) {
                ...
                System.out.println("The Left food" + p.getReceiver().getUnfreshfoodList().size());
                p.getReceiver().addToUnfreshList(p.getOrder().getOrderList());
                System.out.println("The Left food" + p.getReceiver().getUnfreshfoodList().size());
                try {
                    streamOut.reset();
                    streamOut.writeObject(system);
                    System.out.println(system.getNetworkList().get(0).getEnterpriseDirectory().getEnterpriseList().get(5).getOrganizationDirectory().getOrganizationList().get(0).getUserAccountDirectory().getUserAccountList().get(0).getWorkQueue().getWorkRequestList().size());
                    streamOut.flush();
                } catch (Exception e) {
