    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    System.out.println("name"+fs.getDish());
                    System.out.println("number:"+fs.getNumber());
                    int a = fs.getNumber();
                    if(a>number)
                    {
                        System.out.println("Entering if");
                            System.out.println("if the number is"+number);
                        int remain = a-number;
                        fs.setNumber(remain);
                        ...
                        fs.setNumber(0);
                        System.out.println("here remaining"+number);
                   }
                }
