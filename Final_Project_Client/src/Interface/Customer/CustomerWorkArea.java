...
public class CustomerWorkArea extends javax.swing.JPanel {
    ...
    public void populateMark() {
        Restaurant r = (Restaurant) jComboBox2.getSelectedItem();
        jLabel5.setText(String.valueOf(r.getMark()) + " Star");
    }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ImageIcon image1 = new ImageIcon(((OnlineDish) jTable1.getValueAt(i, 0)).getPic());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        CustomerJPanel panel = new CustomerJPanel(system, userProcessContainer, userAccount, network, streamOut);
